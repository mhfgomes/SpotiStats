...
- **Listening History** — Browse your recently played tracks with pagination
...
- **Auto-Sync** — Background sync every 30 minutes via Convex cron jobs
...
- **playHistory** — Recently played tracks with timestamps
- **syncCursors** — Pagination cursors for incremental sync
